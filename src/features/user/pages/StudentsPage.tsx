...
/**
 * StudentsPage - Administrative management of library patrons and scholars.
 */
const StudentsPage = () => {
  return (
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-black text-white tracking-tight">
            Gestión de <span className="text-[#b59a5d]">Estudiantes</span>
          </h1>
          <p className="text-slate-400 font-serif italic text-lg leading-relaxed">
            Administre el acceso y registros de la comunidad académica.
          </p>
